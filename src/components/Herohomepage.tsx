...
// Generated: 2025-08-29T11:29:28.708Z
// Template: hero-c001
// Context: Homepage
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary">
              ...
              New: Zero-Config Cloud Infrastructure
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              MinimalTech eliminates complexity from your development workflow. Deploy, scale, and monitor 
              your applications with clean, intuitive tools built for modern developers.
            </p>
